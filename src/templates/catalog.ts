...
export const OFFICIAL_TEMPLATE_CATALOG: OfficialTemplateSpec[] = [
  {
    ...
    description: "Official sn-jnl package (sn-jnl.cls, bst/, sn-article.tex).",
  ...
  },
  {
    ...
    publisher: "Elsevier",
    description: "Official elsarticle journal class package (CTAN).",
  ...
  },
  {
    ...
    name: "ACM acmart",
    publisher: "ACM",
    description: "Official ACM acmart class + sample-sigconf (CTAN / package sources).",
